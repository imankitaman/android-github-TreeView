package ankit.com.githubtreeview.uiutils;
...
public class TreeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setTreeLeaf(List<? extends TreeViewBinder> viewBinders) {
        this.viewBinders = viewBinders;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (onTreeNodeListener != null && onTreeNodeListener.onClick(selectedNode, displayNodes.get(position).getRepoInfo(),holder))
                    return;
    ...
    public interface OnTreeNodeListener {
         ...
         */
        boolean onClick(TreeNode node, Repo repo, RecyclerView.ViewHolder holder);
